...
export default function ServiceOrderView() {
  ...
  async function handleOrder() {
    ...
    try {
      ...
      notify(
        "success",
        "Đặt dịch vụ thành công! Admin sẽ xử lý trong thời gian sớm nhất.",
      );
        ...
        <div className="card" style={{ padding: 24 }}>
          ...
          {!showForm ? (
            ...
            >
              ...
              >
                Khi thuê 1 dịch vụ không đổi mật khẩu để tránh làm gián đoạn
