...
export function auditActionLabel(action: string) {
  const labels: Record<string, string> = {
    ...
    USER_VIEW_SECRET: "User xem thông tin 1 sản phẩm",

    ADMIN_CREATE_LISTING: "Admin tạo 1 sản phẩm",
    ADMIN_UPDATE_LISTING: "Admin sửa 1 sản phẩm",
    ADMIN_DELETE_LISTING: "Admin xóa  1sản phẩm",
    ADMIN_UPLOAD_LISTING_IMAGE: "Admin upload ảnh 1 sản phẩm",
    ADMIN_DELETE_LISTING_IMAGE: "Admin xóa ảnh 1 sản phẩm",
